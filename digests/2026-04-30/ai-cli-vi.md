...
| # | 标题 | 状态 | 核心痛点 | 社区价值 |
|---|------|------|---------|---------|
| [#1956](https://github.com/MoonshotAI/kimi-cli/issues/1956) | ACP integration: Session history is not replayed or available to clients | 🔴 OPEN | Zed/JetBrains 等 IDE 通过 ACP 连接时，切换会话后历史上下文丢失，每次从零开始 | **阻断级问题**：直接影响 IDE 插件的